...
string Tienda::ObtenerNombreProducto(int id)
{
    string nombreProducto =  productos[id - 1]->ObtenerNombreP();
    return nombreProducto;
}

int Tienda::ObtenerExistenciasProducto(int id)
{
    int existenciasProducto = productos[id - 1]->ObtenerExistencias();
...
void Tienda::ModificarProducto( int idAModificar, string nombreModificado, int existenciasModificado)
{
      productos[idAModificar - 1]->ModificarNombre(nombreModificado);
      productos[idAModificar - 1]->ModificarExistencias(existenciasModificado);
}

void Tienda::EliminarProducto(int idAEliminar)
{
    delete productos[idAEliminar - 1];
}
